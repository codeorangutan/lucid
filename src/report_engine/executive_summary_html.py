...
def generate_cognitive_profile_summary_html(data: Dict[str, Any]) -> str:
    ...
    # --- Styles ---
    style = '''<style>
    .exec-summary-section { margin-bottom: 0.8em; }
    .exec-summary-section h2 { color: #1e3a8a; font-size: 1.1em; margin-bottom: 0.2em; }
    .exec-summary-section ul { margin: 0.2em 0 0.2em 1.2em; padding: 0; }
    .exec-summary-section li { margin: 0.1em 0; }
    .exec-summary-key { background: #e0e7ff; border-radius: 6px; padding: 0.2em 0.5em; display: inline-block; }
    .exec-summary-note { color: #475569; font-size: 0.92em; margin-bottom: 0.5em; display: block; }
    .adhd-criteria-list { margin: 0 0 0 1.8em !important; padding-left: 0 !important; list-style-type: none !important; }
    .adhd-criteria-list li { margin: 0 !important; padding: 0 !important; text-indent: -1.2em !important; padding-left: 1.2em !important; line-height: 1.25 !important; }
    </style>'''
    ...
    # --- HTML Output ---
    note = '<span class="exec-summary-note"><strong>Note:</strong> This assessment is a screening tool and is <strong>not diagnostic</strong>. Results should be interpreted by a qualified healthcare professional. Invalid test results have been excluded from interpretation below.</span>'
