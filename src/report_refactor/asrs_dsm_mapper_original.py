...
def create_asrs_dsm_section(asrs_responses):
    ...
    # Create tables with styling - narrower columns and reduced padding
    table_a = Table(criterion_a_data, repeatRows=1, colWidths=[180, 240, 50, 50])
    style_a = [
    ...
    table_b = Table(criterion_b_data, repeatRows=1, colWidths=[180, 240, 50, 50])
    style_b = [
        ('BACKGROUND', (0, 0), (-1, 0), colors.grey),
        ('TEXTCOLOR', (0, 0), (-1, 0), colors.whitesmoke),
        ('GRID', (0, 0), (-1, -1), 0.5, colors.black),
    ...
    diagnosis_table = Table(diagnosis_data, colWidths=[180, 240])
    diagnosis_style = [
        ('GRID', (0, 0), (-1, -1), 0.5, colors.black),
        ('SPAN', (0, 0), (-1, 0)),
    ...
    # Return elements without page break
    return [asrs_elements]